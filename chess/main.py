...
from chessAi2 import ChessAI


ai = ChessAI(model_path='chess_model_tf.h5')

# Initialize the mixer
p.mixer.init()
# Load sound files
move_sound = p.mixer.Sound("D:/Chess/chess-ai/sounds/move-sound.mp3")
capture_sound = p.mixer.Sound("D:/Chess/chess-ai/sounds/capture.mp3")
promote_sound = p.mixer.Sound("D:/Chess/chess-ai/sounds/promote.mp3")
...
def loadImages():
    ...
    for piece in pieces:
        image_path = "D:/Chess/chess-ai/images1/" + piece + ".png"
    ...
    if gs.whiteToMove:
        button_images = [
            p.transform.smoothscale(p.image.load(
                "D:/Chess/chess-ai/images1/bQ.png"), (100, 100)),
            p.transform.smoothscale(p.image.load(
                "D:/Chess/chess-ai/images1/bR.png"), (100, 100)),
            p.transform.smoothscale(p.image.load(
                "D:/Chess/chess-ai/images1/bB.png"), (100, 100)),
            p.transform.smoothscale(p.image.load("D:/Chess/chess-ai/images1/bN.png"), (100, 100))
        ]
    else:
        button_images = [
            p.transform.smoothscale(p.image.load(
                "D:/Chess/chess-ai/images1/wQ.png"), (100, 100)),
            p.transform.smoothscale(p.image.load(
                "D:/Chess/chess-ai/images1/wR.png"), (100, 100)),
            p.transform.smoothscale(p.image.load(
                "D:/Chess/chess-ai/images1/wB.png"), (100, 100)),
            p.transform.smoothscale(p.image.load("D:/Chess/chess-ai/images1/wN.png"), (100, 100))
        ]
    ...
    while running:
        ...
        if not gameOver and not humanTurn and not moveUndone:
            ...
            if not moveFinderProcess.is_alive():
                ...
                AIMove = ai.find_best_move(gs, depth=2)
